class Game extends React.Component {
  ...
  render() {
    return (
      ...
      React.createElement("h1", null, this.state.winner > 0 ? this.state.winner == 1 ? "Black Wins" : "Red Wins" : this.state.player ? "Blacks Turn" : "Reds Turn", " "),
...
function Cell(props) {
  ...
  return (
    React.createElement("div", { style: style, onClick: () => props.handleClick(props.row, props.col) },
